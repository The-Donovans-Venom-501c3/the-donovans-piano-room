...
const rulesData: Record<string, { Introduction: string; Explanation: string[] }> = {
  ...
  chord: {
    Introduction: 'Identify the chord shown on the staff.',
    Explanation: ['Use the notes and accidentals to identify the chord.'],
  },
  ledger: {
    Introduction: 'Identify the ledger line note shown on the staff.',
    Explanation: ['Use the note names and accidentals to identify the answer.'],
  },
  reading: {
    Introduction: 'Complete the missing letters in the musical sentence.',
    Explanation: ['Drag the correct notes into each blank.'],
  },
};
