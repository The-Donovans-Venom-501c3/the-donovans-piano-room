...
export default function SuccessPopup({closeSuccessPopup}: {closeSuccessPopup: any}) {
  ...
  return (
    < /* div className="absolute flex items-center justify-between h-[6vh] w-[78vw] bottom-[1vh] bg-primary-yellow-accent rounded-2xl" style={isNavOpen ? {width: '70vw'} : {}} */ div className="fixed z-50 flex items-center justify-between h-[48px] w-[78vw] bottom-[1vh] bg-primary-yellow-accent rounded-2xl" style={isNavOpen ? { width: '70vw' } : {} } >
