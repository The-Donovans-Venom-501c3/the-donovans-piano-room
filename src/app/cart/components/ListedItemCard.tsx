...
const ListedItemCard = ({ book, index }: { book: bookCartItemInterface, index: number }) => {
  ...
  const decreaseQuantity = () => setAddedCartItems(prev => {
    const updated = [...prev];
  ...
  return (
    <div className="flex flex-row  items-center p-8 gap-6 w-full h-full tablet:w-full tablet:h-[72%] laptop:w-full laptop:h-[75%] bg-white rounded-[12px] shadow-md">
      {/* Image Section */}
