...
export default function LoginForm() {
    ...
    return (
        <div className="w-[24vw] 3xl:w-[26vw]">
            <Link href="/" className="text-primary-yellow font-montserrat text-xl font-bold flex relative w-[15%] mb-5"><Image src="/YellowBackIcon.svg" width={30} height={30} alt=""/><p className="mt-2">Home</p></Link>
        <h1 className="text-7xl font-montserrat font-bold leading-tight tracking-tight text-white mb-5">
        Log In
        </h1>
