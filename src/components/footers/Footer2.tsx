  ...
  return (
    <div className='fixed flex justify-center items-center bottom-0 w-full border-t-2 border-[#A135E8] backdrop-blur-sm h-[9.3vh] z-40'>
        <div className='flex justify-between h-[28px] w-[84.7%] z-50'>
            ...
            >Copyright © {new Date().getFullYear()} The Donovan&apos;s Piano Room. Powered by <Link className='text-primary-yellow underline' target='_blank' href='https://www.thedonovan.org/'>The Donovan&apos;s Venom</Link>, a 501(c)(3) nonprofit organization.</h2>
