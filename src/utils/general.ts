...
export const profile = {
  // to be removed after BE Integration
...
export const pronouns = ["She/Her/Hers", "He/Him/His", "They/Them/Theirs"];
...
export function beenTimeAgo(date: Date): {
  timeAgo: string;
  underADay: boolean;
} {
  ...
  for (const [unit, value] of units) {
    if (seconds >= value) {
      ...
      return {
        ...
        underADay: value <= 3600 ? true : false,
      };
    }
  }
...
export const dummyNoticationsData = [
  {
    ...
    description:
      "Version 9.0.1 has launched, featuring enhanced stability, improved features, and critical bug fixes. Upgrade now for a smoother, more efficient user experience.",
    actionTitle: "Update",
  ...
  },
  {
    ...
    description:
      "Renew your annual program today to continue enjoying all the benefits and features. Don't miss out on the latest updates and exclusive member services for another year!",
    actionTitle: "Renew",
  ...
  },
  {
    ...
    description:
      "Upload your profile photo to personalize your account and enhance your visibility. A current photo helps others recognize and connect with you more effectively!",
...
export const mapBackendToFrontend = (
  backendBook: backendBookInterface,
): bookInterface => {
  return {
    id: backendBook.id,
...
export async function guestUserResult() {
  try {
